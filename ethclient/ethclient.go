...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, gbchian.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*gbchian.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (gbchian.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q gbchian.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q gbchian.FilterQuery, ch chan<- types.Log) (gbchian.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q gbchian.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg gbchian.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg gbchian.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg gbchian.CallMsg) (uint64, error) {
...
func toCallArg(msg gbchian.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
