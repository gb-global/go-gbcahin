...
//		tokenAddress = params.SubChainCtxAddress
//	}
//	gasLimit, err := erc20_client.EstimateGas(context.Background(), gbchian.CallMsg{
...
//
//	if gasLimit <= 0 {
//		gasLimit, err = client.EstimateGas(context.Background(), gbchian.CallMsg{
//			From: anchorAddr, //若无From字段，方法中的require(msg.sender)会报错
//			To:   &tokenAddress,
//			Data: data,
//		})
...
//	data = append(data, methodID...)
//	data = append(data, paddedCtxId...)
//	result, err := client.PendingCallContract(context.Background(), gbchian.CallMsg{
//		To:   &tokenAddress,
//		Data: data,
//	})
//	if err != nil {
