...
import (
	...
	math2 "gbchain-org/go-gbchain/common/math"
...
// newAlethGenesisSpec converts a go-gbchian genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-gbchian and aleth
...
// newParityChainSpec converts a go-bchain genesis block into a Parity specific
// chain specification format.
