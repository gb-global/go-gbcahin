...
import (
	...
	"gbchain-org/go-gbchain/internal/debug"
	...
	"gbchain-org/go-gbchain/stratum"
...
const (
	clientIdentifier = "gbchian" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, gitDate, "the go-gbchain command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2020-2024 The gbchain Authors"
...
func gbchian(ctx *cli.Context) error {
