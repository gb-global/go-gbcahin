...
import (
	...
	"gbchain-org/go-gbchain/internal/cmdtest"
	"gbchain-org/go-gbchain/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gbchian-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gbchian-test" in runGeth.
	reexec.Register("gbchian-test", func() {
