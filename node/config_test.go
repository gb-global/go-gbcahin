...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbchian.ipc", false, filepath.Join(os.TempDir(), "gbchian.ipc")},
		{"data", "gbchian.ipc", false, "data/gbchian.ipc"},
		{"data", "./gbchian.ipc", false, "./gbchian.ipc"},
		{"data", "/gbchian.ipc", false, "/gbchian.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbchian.ipc", true, `\\.\pipe\gbchian.ipc`},
		{"data", "gbchian.ipc", true, `\\.\pipe\gbchian.ipc`},
		{"data", `\\.\pipe\gbchian.ipc`, true, `\\.\pipe\gbchian.ipc`},
	}
