...
func init() {
	...
	if runtime.GOOS == "darwin" {
		DefaultConfig.Ethash.DatasetDir = filepath.Join(home, "Library", "Cdthash") //TODO Ethash
	} else if runtime.GOOS == "windows" {
		localappdata := os.Getenv("LOCALAPPDATA")
		if localappdata != "" {
			DefaultConfig.Ethash.DatasetDir = filepath.Join(localappdata, "Cdthash") //TODO Ethash
		} else {
			DefaultConfig.Ethash.DatasetDir = filepath.Join(home, "AppData", "Local", "Cdthash") //TODO Ethash
		}
	} else {
		DefaultConfig.Ethash.DatasetDir = filepath.Join(home, ".ctdhash") // ethash
	}
}
